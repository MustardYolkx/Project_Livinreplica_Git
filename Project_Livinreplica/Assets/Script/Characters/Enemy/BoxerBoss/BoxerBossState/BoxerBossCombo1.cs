...
public class BoxerBossCombo1 : EnemyAttackState
{
    public new Enemy_BoxerBoss enemy;
    
    public BoxerBossCombo1(EnemyStateMachine enemyStateMachine, Enemy_BoxerBoss enemyScr) : base(enemyStateMachine, enemyScr)
    {
        enemy = enemyScr;
    }
    ...
    public override void Enter()
    {
        ...
        StartAnimation(enemy.boxerBossAnimationData.BoxerBossCombo1ParHash);
    }
    ...
    { 
        base.Exit();
        attackCountIndex = 0;
        StopAnimation(enemy.boxerBossAnimationData.BoxerBossCombo1ParHash);
    }
    #endregion
